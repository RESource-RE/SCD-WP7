			...
			if (FileIO.LoadFile(fileName, fData))
			{
				while (!FileIO.ReachedEndOfFile())
				{
					...
					if (b > 128)
					{
						...
						int num9 = num;
						array8[num9].xPivot = (short)(array8[num9].xPivot + (b - 128 << 8));
					...
					else
					{
						...
						int num10 = num;
						array9[num10].xPivot = (short)(array9[num10].xPivot + (b << 8));
					}
					b = FileIO.ReadByte();
					...
					if (b > 128)
					{
						...
						int num11 = num;
						array10[num11].yPivot = (short)(array10[num11].yPivot + (b - 128 << 8));
					...
					else
					{
						...
						int num12 = num;
						array11[num12].yPivot = (short)(array11[num12].yPivot + (b << 8));
					}
					b = FileIO.ReadByte();
					...
					if (b > 128)
					{
						...
						int num13 = num;
						array12[num13].xAdvance = (short)(array12[num13].xAdvance + (b - 128 << 8));
					...
					else
					{
						...
						int num14 = num;
						array13[num14].xAdvance = (short)(array13[num14].xAdvance + (b << 8));
					}
					b = FileIO.ReadByte();
					b = FileIO.ReadByte();
					num++;
