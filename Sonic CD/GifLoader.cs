...
namespace Retro_Engine
{
    ...
    public static class GifLoader
    {
      ...
      public const int LZ_MAX_CODE = 4095 /*0x0FFF*/;
      public const int LZ_BITS = 12;
      public const int FLUSH_OUTPUT = 4096 /*0x1000*/;
      public const int FIRST_CODE = 4097;
      public const int NO_SUCH_CODE = 4098;
      public const int HT_SIZE = 8192 /*0x2000*/;
      public const int HT_KEY_MASK = 8191 /*0x1FFF*/;
      ...
      public static void InitGifDecoder()
      {
        ...
        for (int index = 0; index <= 4095 /*0x0FFF*/; ++index)
          ...
          else
          {
            ...
            else
            {
              ...
              if (GifLoader.gifDecoder.prefix[code2] == 4098U)
              {
                ...
                index = code2;
              int num2;
              for (num2 = 0; num2++ <= 4095 /*0x0FFF*/ && index > clearCode && index <= 4095 /*0x0FFF*/; index = (int) GifLoader.gifDecoder.prefix[index])
                GifLoader.gifDecoder.stack[stackPtr++] = GifLoader.gifDecoder.suffix[index];
              if (num2 >= 4095 /*0x0FFF*/ | index > 4095 /*0x0FFF*/)
                return;
      ...
      {
        int num = 0;
        while (code > clearCode && num++ <= 4095 /*0x0FFF*/)
