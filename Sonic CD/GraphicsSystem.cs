...
namespace Retro_Engine
{
    ...
    public static class GraphicsSystem
    {
      ...
      public static void DrawSprite(
        ...
        int surfaceNum)
      {
        if (GraphicsSystem.gfxSurface[surfaceNum].texStartX <= -1 || GraphicsSystem.gfxVertexSize >= (ushort) 8192 /*0x2000*/ || xPos <= -512 || xPos >= 872 || yPos <= -512 || yPos >= 752)
          return;
      ...
      public static void DrawScaledSprite(
        ...
        int surfaceNum)
      {
        if (GraphicsSystem.gfxVertexSize >= (ushort) 8192 /*0x2000*/ || xPos <= -512 || xPos >= 872 || yPos <= -512 || yPos >= 752)
          return;
        xScale <<= 2;
        yScale <<= 2;
      ...
      public static void DrawScaledChar(
        ...
        int surfaceNum)
      {
        if (GraphicsSystem.gfxVertexSize >= (ushort) 8192 /*0x2000*/ || xPos <= -8192 || xPos >= 13951 || yPos <= -1024 || yPos >= 4864)
          return;
        ...
        int surfaceNum)
      {
        ...
        if (GraphicsSystem.gfxSurface[surfaceNum].texStartX <= -1 || GraphicsSystem.gfxVertexSize >= (ushort) 8192 /*0x2000*/ || xPos <= -8192 || xPos >= 13952 || yPos <= -8192 || yPos >= 12032)
          return;
        if (direction == (byte) 0)
        {
          int num3 = -xPivot;
