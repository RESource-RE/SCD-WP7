...
namespace Retro_Engine
{
    ...
    public static class PlayerSystem
    {
      ...
      {
        int num1 = playerO.xPos >> 16 /*0x10*/;
        int num2 = playerO.yPos >> 16 /*0x10*/;
        ...
        {
          if (StageSystem.yScrollOffset + 240 /*0xF0*/ < StageSystem.yBoundary2 && StageSystem.yScrollOffset + 240 /*0xF0*/ > StageSystem.newYBoundary2)
            StageSystem.yBoundary2 = StageSystem.yScrollOffset + 240 /*0xF0*/;
          else
            --StageSystem.yBoundary2;
        }
        if (StageSystem.newYBoundary2 > StageSystem.yBoundary2)
        {
          if (StageSystem.yScrollOffset + 240 /*0xF0*/ < StageSystem.yBoundary2)
        ...
        if (StageSystem.newXBoundary1 < StageSystem.xBoundary1)
        {
          ...
          else
          {
            ...
            {
              StageSystem.xBoundary1 += playerO.xVelocity >> 16 /*0x10*/;
        ...
        if (StageSystem.newXBoundary2 > StageSystem.xBoundary2)
        {
          ...
          else
          {
            ...
            if (playerO.xVelocity > 0)
            {
              StageSystem.xBoundary2 += playerO.xVelocity >> 16 /*0x10*/;
        ...
        {
          StageSystem.yScrollMove = 32 /*0x20*/;
        }
        else
        {
          if (StageSystem.yScrollMove == 32 /*0x20*/)
          {
        ...
        if (num6 < StageSystem.yBoundary1)
        {
          ...
          num7 = StageSystem.yBoundary1 + 240 /*0xF0*/;
        }
        if (num7 > StageSystem.yBoundary2)
        {
          num7 = StageSystem.yBoundary2;
          num6 = StageSystem.yBoundary2 - 240 /*0xF0*/;
        }
        ...
        if (num8 + playerO.lookPos > num6 + 104)
        {
          ...
          if (num8 + playerO.lookPos > num7 - 136)
          {
            ...
            StageSystem.yScrollOffset = num7 - 240 /*0xF0*/ - StageSystem.screenShakeY;
          }
        }
        else
        {
      ...
      public static void SetPlayerScreenPositionCDStyle(PlayerObject playerO)
      {
        ...
        switch (StageSystem.cameraShift)
        {
          ...
          case 1:
            ...
            break;
          case 2:
            if (StageSystem.xScrollMove < 64 /*0x40*/)
            {
              StageSystem.xScrollMove += 2;
              break;
            }
        ...
        if (num3 < StageSystem.yBoundary1)
        {
          ...
          num4 = StageSystem.yBoundary1 + 240 /*0xF0*/;
        }
        if (num4 > StageSystem.yBoundary2)
        {
          num4 = StageSystem.yBoundary2;
          num3 = StageSystem.yBoundary2 - 240 /*0xF0*/;
        }
        ...
        if (num5 + playerO.lookPos > num3 + 104)
        {
          ...
          if (num5 + playerO.lookPos > num4 - 136)
          {
            ...
            StageSystem.yScrollOffset = num4 - 240 /*0xF0*/ - StageSystem.screenShakeY;
          }
        }
        else
        {
      ...
      public static void SetPlayerLockedScreenPosition(PlayerObject playerO)
      {
        ...
        if (num3 + playerO.lookPos > yScrollA + 104)
        {
          ...
          if (num3 + playerO.lookPos > yScrollB - 136)
          {
            ...
            StageSystem.yScrollOffset = yScrollB - 240 /*0xF0*/ - StageSystem.screenShakeY;
          }
        }
        else
        {
      ...
      public static void ProcessAirCollision(PlayerObject playerO)
      {
        ...
        {
          num1 = (byte) 1;
          PlayerSystem.cSensor[0].yPos = playerO.yPos + 131072 /*0x020000*/;
          PlayerSystem.cSensor[0].collided = (byte) 0;
          PlayerSystem.cSensor[0].xPos = playerO.xPos + (PlayerSystem.collisionRight << 16 /*0x10*/);
        }
        else
          num1 = (byte) 0;
        byte num2;
        ...
        {
          num2 = (byte) 1;
          PlayerSystem.cSensor[1].yPos = playerO.yPos + 131072 /*0x020000*/;
          PlayerSystem.cSensor[1].collided = (byte) 0;
          PlayerSystem.cSensor[1].xPos = playerO.xPos + (PlayerSystem.collisionLeft - 1 << 16 /*0x10*/);
        }
        else
          num2 = (byte) 0;
        PlayerSystem.cSensor[2].xPos = playerO.xPos + ((int) collisionBox.left[1] << 16 /*0x10*/);
        PlayerSystem.cSensor[3].xPos = playerO.xPos + ((int) collisionBox.right[1] << 16 /*0x10*/);
        ...
        {
          num3 = (byte) 1;
          PlayerSystem.cSensor[2].yPos = playerO.yPos + (PlayerSystem.collisionBottom << 16 /*0x10*/);
          PlayerSystem.cSensor[3].yPos = playerO.yPos + (PlayerSystem.collisionBottom << 16 /*0x10*/);
        }
        else
          num3 = (byte) 0;
        byte num4 = 1;
        PlayerSystem.cSensor[4].yPos = playerO.yPos + (PlayerSystem.collisionTop - 1 << 16 /*0x10*/);
        PlayerSystem.cSensor[5].yPos = playerO.yPos + (PlayerSystem.collisionTop - 1 << 16 /*0x10*/);
        ...
        while (num5 > 0)
        {
          ...
          if (num1 == (byte) 1)
          {
            PlayerSystem.cSensor[0].xPos += num6 + 65536 /*0x010000*/;
          ...
          if (num2 == (byte) 1)
          {
            PlayerSystem.cSensor[1].xPos += num6 - 65536 /*0x010000*/;
          ...
          if (num1 == (byte) 2)
          {
            playerO.xVelocity = 0;
            playerO.speed = 0;
            playerO.xPos = PlayerSystem.cSensor[0].xPos - PlayerSystem.collisionRight << 16 /*0x10*/;
            PlayerSystem.cSensor[2].xPos = playerO.xPos + (PlayerSystem.collisionLeft + 1 << 16 /*0x10*/);
            PlayerSystem.cSensor[3].xPos = playerO.xPos + (PlayerSystem.collisionRight - 2 << 16 /*0x10*/);
            PlayerSystem.cSensor[4].xPos = PlayerSystem.cSensor[2].xPos;
            PlayerSystem.cSensor[5].xPos = PlayerSystem.cSensor[3].xPos;
            num6 = 0;
            num8 = 0;
          ...
          if (num2 == (byte) 2)
          {
            playerO.xVelocity = 0;
            playerO.speed = 0;
            playerO.xPos = PlayerSystem.cSensor[1].xPos - PlayerSystem.collisionLeft + 1 << 16 /*0x10*/;
            PlayerSystem.cSensor[2].xPos = playerO.xPos + (PlayerSystem.collisionLeft + 1 << 16 /*0x10*/);
            PlayerSystem.cSensor[3].xPos = playerO.xPos + (PlayerSystem.collisionRight - 2 << 16 /*0x10*/);
            PlayerSystem.cSensor[4].xPos = PlayerSystem.cSensor[2].xPos;
            PlayerSystem.cSensor[5].xPos = PlayerSystem.cSensor[3].xPos;
        ...
        else
        {
          if (num3 == (byte) 2)
          {
            ...
            if (PlayerSystem.cSensor[2].collided == (byte) 1 && PlayerSystem.cSensor[3].collided == (byte) 1)
            {
              ...
              {
                playerO.yPos = PlayerSystem.cSensor[2].yPos - PlayerSystem.collisionBottom << 16 /*0x10*/;
                playerO.angle = PlayerSystem.cSensor[2].angle;
              }
              else
              {
                playerO.yPos = PlayerSystem.cSensor[3].yPos - PlayerSystem.collisionBottom << 16 /*0x10*/;
            ...
            if (playerO.angle > 160 /*0xA0*/ && playerO.angle < 224 /*0xE0*/ && playerO.collisionMode != (byte) 1)
            {
              playerO.collisionMode = (byte) 1;
              playerO.xPos -= 262144 /*0x040000*/;
            }
            if (playerO.angle > 32 /*0x20*/ && playerO.angle < 96 /*0x60*/ && playerO.collisionMode != (byte) 3)
            {
              playerO.collisionMode = (byte) 3;
              playerO.xPos += 262144 /*0x040000*/;
            }
            if (playerO.angle < 32 /*0x20*/ | playerO.angle > 224 /*0xE0*/)
              playerO.controlLock = (byte) 0;
            playerO.objectPtr.rotation = playerO.angle << 1;
            int num10 = playerO.down != (byte) 1 ? (playerO.angle >= 128 /*0x80*/ ? (playerO.angle <= 240 /*0xF0*/ ? (playerO.angle <= 224 /*0xE0*/ ? (Math.Abs(playerO.xVelocity) <= Math.Abs(playerO.yVelocity) ? -playerO.yVelocity : playerO.xVelocity) : (Math.Abs(playerO.xVelocity) <= Math.Abs(playerO.yVelocity >> 1) ? -(playerO.yVelocity >> 1) : playerO.xVelocity)) : playerO.xVelocity) : (playerO.angle >= 16 /*0x10*/ ? (playerO.angle >= 32 /*0x20*/ ? (Math.Abs(playerO.xVelocity) <= Math.Abs(playerO.yVelocity) ? playerO.yVelocity : playerO.xVelocity) : (Math.Abs(playerO.xVelocity) <= Math.Abs(playerO.yVelocity >> 1) ? playerO.yVelocity >> 1 : playerO.xVelocity)) : playerO.xVelocity)) : (playerO.angle >= 128 /*0x80*/ ? (playerO.angle <= 240 /*0xF0*/ ? (playerO.angle <= 224 /*0xE0*/ ? (Math.Abs(playerO.xVelocity) <= Math.Abs(playerO.yVelocity) ? -(playerO.yVelocity + playerO.yVelocity / 12) : playerO.xVelocity) : (Math.Abs(playerO.xVelocity) <= Math.Abs(playerO.yVelocity >> 1) ? -(playerO.yVelocity + playerO.yVelocity / 12 >> 1) : playerO.xVelocity)) : playerO.xVelocity) : (playerO.angle >= 16 /*0x10*/ ? (playerO.angle >= 32 /*0x20*/ ? (Math.Abs(playerO.xVelocity) <= Math.Abs(playerO.yVelocity) ? playerO.yVelocity + playerO.yVelocity / 12 : playerO.xVelocity) : (Math.Abs(playerO.xVelocity) <= Math.Abs(playerO.yVelocity >> 1) ? playerO.yVelocity + playerO.yVelocity / 12 >> 1 : playerO.xVelocity)) : playerO.xVelocity));
            if (num10 < -1572864)
              num10 = -1572864;
            if (num10 > 1572864 /*0x180000*/)
              num10 = 1572864 /*0x180000*/;
            playerO.speed = num10;
            playerO.yVelocity = 0;
          ...
          if (PlayerSystem.cSensor[4].collided == (byte) 1 && PlayerSystem.cSensor[5].collided == (byte) 1)
          {
            ...
            {
              playerO.yPos = PlayerSystem.cSensor[4].yPos - PlayerSystem.collisionTop + 1 << 16 /*0x10*/;
              num5 = PlayerSystem.cSensor[4].angle;
            }
            else
            {
              playerO.yPos = PlayerSystem.cSensor[5].yPos - PlayerSystem.collisionTop + 1 << 16 /*0x10*/;
          ...
          if (num11 > 64 /*0x40*/ && num11 < 98 && num12 > 160 /*0xA0*/ && num12 < 194)
          {
            playerO.gravity = (byte) 0;
            playerO.angle = num11;
            playerO.objectPtr.rotation = playerO.angle << 1;
            playerO.collisionMode = (byte) 3;
            playerO.xPos += 262144 /*0x040000*/;
            playerO.yPos -= 131072 /*0x020000*/;
            playerO.speed = playerO.angle <= 96 /*0x60*/ ? playerO.yVelocity : playerO.yVelocity >> 1;
          }
          if (num11 > 158 && num11 < 192 /*0xC0*/ && num12 > 190 && num12 < 224 /*0xE0*/)
          {
            playerO.gravity = (byte) 0;
            playerO.angle = num11;
            playerO.objectPtr.rotation = playerO.angle << 1;
            ...
            playerO.xPos -= 262144 /*0x040000*/;
            playerO.yPos -= 131072 /*0x020000*/;
            playerO.speed = playerO.angle >= 160 /*0xA0*/ ? -playerO.yVelocity : -playerO.yVelocity >> 1;
          }
          if (playerO.yVelocity < 0)
            playerO.yVelocity = 0;
      ...
      public static void SetPathGripSensors(PlayerObject playerO)
      {
        ...
        switch (playerO.collisionMode)
        {
          case 0:
            ...
            PlayerSystem.collisionRight = (int) collisionBox.right[0];
            PlayerSystem.collisionBottom = (int) collisionBox.bottom[0];
            PlayerSystem.cSensor[0].yPos = PlayerSystem.cSensor[4].yPos + (PlayerSystem.collisionBottom << 16 /*0x10*/);
            PlayerSystem.cSensor[1].yPos = PlayerSystem.cSensor[0].yPos;
            PlayerSystem.cSensor[2].yPos = PlayerSystem.cSensor[0].yPos;
            PlayerSystem.cSensor[3].yPos = PlayerSystem.cSensor[4].yPos + 262144 /*0x040000*/;
            PlayerSystem.cSensor[0].xPos = PlayerSystem.cSensor[4].xPos + ((int) collisionBox.left[1] - 1 << 16 /*0x10*/);
            PlayerSystem.cSensor[1].xPos = PlayerSystem.cSensor[4].xPos;
            PlayerSystem.cSensor[2].xPos = PlayerSystem.cSensor[4].xPos + ((int) collisionBox.right[1] << 16 /*0x10*/);
            if (playerO.speed > 0)
            {
              PlayerSystem.cSensor[3].xPos = PlayerSystem.cSensor[4].xPos + (PlayerSystem.collisionRight + 1 << 16 /*0x10*/);
              break;
            }
            PlayerSystem.cSensor[3].xPos = PlayerSystem.cSensor[4].xPos + (PlayerSystem.collisionLeft - 1 << 16 /*0x10*/);
            break;
          case 1:
            ...
            PlayerSystem.cSensor[0].xPos = PlayerSystem.cSensor[4].xPos + (PlayerSystem.collisionRight << 16 /*0x10*/);
            PlayerSystem.cSensor[1].xPos = PlayerSystem.cSensor[0].xPos;
            PlayerSystem.cSensor[2].xPos = PlayerSystem.cSensor[0].xPos;
            PlayerSystem.cSensor[3].xPos = PlayerSystem.cSensor[4].xPos + 262144 /*0x040000*/;
            PlayerSystem.cSensor[0].yPos = PlayerSystem.cSensor[4].yPos + ((int) collisionBox.top[3] - 1 << 16 /*0x10*/);
            PlayerSystem.cSensor[1].yPos = PlayerSystem.cSensor[4].yPos;
            PlayerSystem.cSensor[2].yPos = PlayerSystem.cSensor[4].yPos + ((int) collisionBox.bottom[3] << 16 /*0x10*/);
            if (playerO.speed > 0)
            {
              PlayerSystem.cSensor[3].yPos = PlayerSystem.cSensor[4].yPos + (PlayerSystem.collisionTop << 16 /*0x10*/);
              break;
            }
            PlayerSystem.cSensor[3].yPos = PlayerSystem.cSensor[4].yPos + (PlayerSystem.collisionBottom - 1 << 16 /*0x10*/);
            break;
          case 2:
            ...
            PlayerSystem.cSensor[0].yPos = PlayerSystem.cSensor[4].yPos + (PlayerSystem.collisionTop - 1 << 16 /*0x10*/);
            PlayerSystem.cSensor[1].yPos = PlayerSystem.cSensor[0].yPos;
            PlayerSystem.cSensor[2].yPos = PlayerSystem.cSensor[0].yPos;
            PlayerSystem.cSensor[3].yPos = PlayerSystem.cSensor[4].yPos - 262144 /*0x040000*/;
            PlayerSystem.cSensor[0].xPos = PlayerSystem.cSensor[4].xPos + ((int) collisionBox.left[5] - 1 << 16 /*0x10*/);
            PlayerSystem.cSensor[1].xPos = PlayerSystem.cSensor[4].xPos;
            PlayerSystem.cSensor[2].xPos = PlayerSystem.cSensor[4].xPos + ((int) collisionBox.right[5] << 16 /*0x10*/);
            if (playerO.speed < 0)
            {
              PlayerSystem.cSensor[3].xPos = PlayerSystem.cSensor[4].xPos + (PlayerSystem.collisionRight + 1 << 16 /*0x10*/);
              break;
          ...
          case 3:
            ...
            PlayerSystem.cSensor[0].xPos = PlayerSystem.cSensor[4].xPos + (PlayerSystem.collisionLeft - 1 << 16 /*0x10*/);
            PlayerSystem.cSensor[1].xPos = PlayerSystem.cSensor[0].xPos;
            PlayerSystem.cSensor[2].xPos = PlayerSystem.cSensor[0].xPos;
            PlayerSystem.cSensor[3].xPos = PlayerSystem.cSensor[4].xPos - 262144 /*0x040000*/;
            PlayerSystem.cSensor[0].yPos = PlayerSystem.cSensor[4].yPos + ((int) collisionBox.top[7] - 1 << 16 /*0x10*/);
            PlayerSystem.cSensor[1].yPos = PlayerSystem.cSensor[4].yPos;
            PlayerSystem.cSensor[2].yPos = PlayerSystem.cSensor[4].yPos + ((int) collisionBox.bottom[7] << 16 /*0x10*/);
            if (playerO.speed > 0)
            {
              PlayerSystem.cSensor[3].yPos = PlayerSystem.cSensor[4].yPos + (PlayerSystem.collisionBottom << 16 /*0x10*/);
              break;
            }
            PlayerSystem.cSensor[3].yPos = PlayerSystem.cSensor[4].yPos + (PlayerSystem.collisionTop - 1 << 16 /*0x10*/);
            break;
        }
      }
          ...
          switch (playerO.collisionMode)
          {
            case 0:
              ...
              for (int index2 = 0; index2 < 3; ++index2)
              {
                ...
                PlayerSystem.FindFloorPosition(playerO, PlayerSystem.cSensor[index2], PlayerSystem.cSensor[index2].yPos >> 16 /*0x10*/);
              }
              index1 = -1;
              for (int index3 = 0; index3 < 3; ++index3)
              {
                if (index1 > -1)
                {
                  if (PlayerSystem.cSensor[index3].collided == (byte) 1)
                  {
                    if (PlayerSystem.cSensor[index3].yPos < PlayerSystem.cSensor[index1].yPos)
                      index1 = index3;
                    if (PlayerSystem.cSensor[index3].yPos == PlayerSystem.cSensor[index1].yPos && PlayerSystem.cSensor[index3].angle < 8 | PlayerSystem.cSensor[index3].angle > 248)
                      index1 = index3;
                  }
                }
                else if (PlayerSystem.cSensor[index3].collided == (byte) 1)
                  index1 = index3;
              }
              if (index1 > -1)
              {
                PlayerSystem.cSensor[0].yPos = PlayerSystem.cSensor[index1].yPos << 16 /*0x10*/;
                ...
                PlayerSystem.cSensor[3].yPos = PlayerSystem.cSensor[0].yPos - 262144 /*0x040000*/;
                PlayerSystem.cSensor[3].angle = PlayerSystem.cSensor[0].angle;
                PlayerSystem.cSensor[4].xPos = PlayerSystem.cSensor[1].xPos;
                PlayerSystem.cSensor[4].yPos = PlayerSystem.cSensor[1].yPos - (PlayerSystem.collisionBottom << 16 /*0x10*/);
              }
              else
                num2 = -1;
              if (PlayerSystem.cSensor[0].angle < 222 && PlayerSystem.cSensor[0].angle > 128 /*0x80*/)
                playerO.collisionMode = (byte) 1;
              if (PlayerSystem.cSensor[0].angle > 34 && PlayerSystem.cSensor[0].angle < 128 /*0x80*/)
              {
                playerO.collisionMode = (byte) 3;
                break;
              }
            ...
            case 1:
              ...
              {
                PlayerSystem.cSensor[index4].xPos += num4;
                PlayerSystem.cSensor[index4].yPos += num5;
                PlayerSystem.FindLWallPosition(playerO, PlayerSystem.cSensor[index4], PlayerSystem.cSensor[index4].xPos >> 16 /*0x10*/);
              }
              index1 = -1;
              for (int index5 = 0; index5 < 3; ++index5)
              {
                if (index1 > -1)
                {
                  if (PlayerSystem.cSensor[index5].xPos < PlayerSystem.cSensor[index1].xPos && PlayerSystem.cSensor[index5].collided == (byte) 1)
                    index1 = index5;
                }
                else if (PlayerSystem.cSensor[index5].collided == (byte) 1)
                  index1 = index5;
              }
              if (index1 > -1)
              {
                PlayerSystem.cSensor[0].xPos = PlayerSystem.cSensor[index1].xPos << 16 /*0x10*/;
                PlayerSystem.cSensor[0].angle = PlayerSystem.cSensor[index1].angle;
                PlayerSystem.cSensor[1].xPos = PlayerSystem.cSensor[0].xPos;
                PlayerSystem.cSensor[1].angle = PlayerSystem.cSensor[0].angle;
                PlayerSystem.cSensor[2].xPos = PlayerSystem.cSensor[0].xPos;
                ...
                PlayerSystem.cSensor[4].xPos = PlayerSystem.cSensor[1].xPos - (PlayerSystem.collisionRight << 16 /*0x10*/);
              }
              else
                num2 = -1;
            ...
            case 2:
              ...
              {
                PlayerSystem.cSensor[index6].xPos += num4;
                PlayerSystem.cSensor[index6].yPos += num5;
                PlayerSystem.FindRoofPosition(playerO, PlayerSystem.cSensor[index6], PlayerSystem.cSensor[index6].yPos >> 16 /*0x10*/);
              }
              index1 = -1;
              for (int index7 = 0; index7 < 3; ++index7)
              {
                if (index1 > -1)
                {
                  if (PlayerSystem.cSensor[index7].yPos > PlayerSystem.cSensor[index1].yPos && PlayerSystem.cSensor[index7].collided == (byte) 1)
                    index1 = index7;
                }
                else if (PlayerSystem.cSensor[index7].collided == (byte) 1)
                  index1 = index7;
              }
              if (index1 > -1)
              {
                ...
                PlayerSystem.cSensor[3].angle = PlayerSystem.cSensor[0].angle;
                PlayerSystem.cSensor[4].xPos = PlayerSystem.cSensor[1].xPos;
                PlayerSystem.cSensor[4].yPos = PlayerSystem.cSensor[1].yPos - (PlayerSystem.collisionTop - 1 << 16 /*0x10*/);
              }
              else
                num2 = -1;
            ...
            case 3:
              ...
              {
                PlayerSystem.cSensor[index8].xPos += num4;
                PlayerSystem.cSensor[index8].yPos += num5;
                PlayerSystem.FindRWallPosition(playerO, PlayerSystem.cSensor[index8], PlayerSystem.cSensor[index8].xPos >> 16 /*0x10*/);
              }
              index1 = -1;
              for (int index9 = 0; index9 < 3; ++index9)
              {
                if (index1 > -1)
                {
                  if (PlayerSystem.cSensor[index9].xPos > PlayerSystem.cSensor[index1].xPos && PlayerSystem.cSensor[index9].collided == (byte) 1)
                    index1 = index9;
                }
                else if (PlayerSystem.cSensor[index9].collided == (byte) 1)
                  index1 = index9;
              }
              if (index1 > -1)
              {
                ...
                PlayerSystem.cSensor[2].angle = PlayerSystem.cSensor[0].angle;
                PlayerSystem.cSensor[4].yPos = PlayerSystem.cSensor[1].yPos;
                PlayerSystem.cSensor[4].xPos = PlayerSystem.cSensor[1].xPos - (PlayerSystem.collisionLeft - 1 << 16 /*0x10*/);
              }
              else
                num2 = -1;
        ...
        switch (playerO.collisionMode)
        {
          case 0:
            if (PlayerSystem.cSensor[0].collided == (byte) 0 && PlayerSystem.cSensor[1].collided == (byte) 0 && PlayerSystem.cSensor[2].collided == (byte) 0)
            {
              ...
              if (playerO.yVelocity < -1048576 /*0xFFF00000*/)
                playerO.yVelocity = -1048576 /*0xFFF00000*/;
              if (playerO.yVelocity > 1048576 /*0x100000*/)
                playerO.yVelocity = 1048576 /*0x100000*/;
              playerO.speed = playerO.xVelocity;
              playerO.angle = 0;
              if (PlayerSystem.cSensor[3].collided == (byte) 1)
              {
                if (playerO.speed > 0)
                  playerO.xPos = PlayerSystem.cSensor[3].xPos - PlayerSystem.collisionRight << 16 /*0x10*/;
                if (playerO.speed < 0)
                  playerO.xPos = PlayerSystem.cSensor[3].xPos - PlayerSystem.collisionLeft + 1 << 16 /*0x10*/;
                playerO.speed = 0;
          ...
          case 1:
            ...
            else if (playerO.speed < 163840 /*0x028000*/ && playerO.speed > -163840 && playerO.controlLock == (byte) 0)
            {
              playerO.gravity = (byte) 1;
              playerO.angle = 0;
              playerO.collisionMode = (byte) 0;
            ...
            {
              if (playerO.speed > 0)
                playerO.yPos = PlayerSystem.cSensor[3].yPos - PlayerSystem.collisionTop << 16 /*0x10*/;
              if (playerO.speed < 0)
                playerO.yPos = PlayerSystem.cSensor[3].yPos - PlayerSystem.collisionBottom << 16 /*0x10*/;
              playerO.speed = 0;
            }
          ...
          case 2:
            ...
            else if (playerO.speed > -163840 && playerO.speed < 163840 /*0x028000*/)
            {
              playerO.gravity = (byte) 1;
              playerO.angle = 0;
              playerO.collisionMode = (byte) 0;
          ...
          case 3:
            ...
            else if (playerO.speed > -163840 && playerO.speed < 163840 /*0x028000*/ && playerO.controlLock == (byte) 0)
            {
              playerO.gravity = (byte) 1;
              playerO.angle = 0;
              playerO.collisionMode = (byte) 0;
            ...
            if (PlayerSystem.cSensor[3].collided == (byte) 1)
            {
              if (playerO.speed > 0)
                playerO.yPos = PlayerSystem.cSensor[3].yPos - PlayerSystem.collisionBottom << 16 /*0x10*/;
              if (playerO.speed < 0)
                playerO.yPos = PlayerSystem.cSensor[3].yPos - PlayerSystem.collisionTop + 1 << 16 /*0x10*/;
              playerO.speed = 0;
            }
            else
              playerO.yPos = PlayerSystem.cSensor[4].yPos;
      ...
      {
        int num1 = cSensorRef.yPos >> 16 /*0x10*/;
        for (int index1 = 0; index1 < 48 /*0x30*/; index1 += 16 /*0x10*/)
        {
          if (cSensorRef.collided == (byte) 0)
          {
            int num2 = cSensorRef.xPos >> 16 /*0x10*/;
            int num3 = num2 >> 7;
            int num4 = (num2 & (int) sbyte.MaxValue) >> 4;
            int num5 = (cSensorRef.yPos >> 16 /*0x10*/) - 16 /*0x10*/ + index1;
            int num6 = num5 >> 7;
              ...
              if (StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] != (byte) 2 && StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] != (byte) 3)
              {
                switch (StageSystem.tile128x128.direction[index2])
                {
                  case 0:
                    ...
                    if ((num5 & 15) > (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index4] - 16 /*0x10*/ + index1 && StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index4] < (sbyte) 15)
                    {
                  ...
                  case 1:
                    ...
                    if ((num5 & 15) > (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index5] - 16 /*0x10*/ + index1 && StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index5] < (sbyte) 15)
                    {
                      cSensorRef.yPos = (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index5] + (num6 << 7) + (num7 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = 256 /*0x0100*/ - ((int) StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & (int) byte.MaxValue);
                      break;
                    }
                    break;
                  case 2:
                    int index6 = (num2 & 15) + (index3 << 4);
                    if ((num5 & 15) > 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index6] - 16 /*0x10*/ + index1)
                    {
                      cSensorRef.yPos = 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index6] + (num6 << 7) + (num7 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = 384 - (int) ((StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & 4278190080U /*0xFF000000*/) >> 24) & (int) byte.MaxValue;
                      break;
                    }
                    break;
                  case 3:
                    int index7 = 15 - (num2 & 15) + (index3 << 4);
                    if ((num5 & 15) > 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index7] - 16 /*0x10*/ + index1)
                    {
                      cSensorRef.yPos = 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index7] + (num6 << 7) + (num7 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = 256 /*0x0100*/ - (384 - (int) ((StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & 4278190080U /*0xFF000000*/) >> 24) & (int) byte.MaxValue);
                      break;
                    }
                    break;
                }
        ...
        int prevCollisionPos)
      {
        ...
        for (int index1 = 0; index1 < 48 /*0x30*/; index1 += 16 /*0x10*/)
        {
          if (cSensorRef.collided == (byte) 0)
          {
            int num1 = cSensorRef.xPos >> 16 /*0x10*/;
            int num2 = num1 >> 7;
            int num3 = (num1 & (int) sbyte.MaxValue) >> 4;
            int num4 = (cSensorRef.yPos >> 16 /*0x10*/) - 16 /*0x10*/ + index1;
            int num5 = num4 >> 7;
            ...
            if (num1 > -1 && num4 > -1)
            {
              ...
              if (StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] != (byte) 2 && StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] != (byte) 3)
              {
                switch (StageSystem.tile128x128.direction[index2])
                {
                  case 0:
                    ...
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index4] < (sbyte) 64 /*0x40*/)
                    {
                  ...
                  case 1:
                    ...
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index5] < (sbyte) 64 /*0x40*/)
                    {
                  ...
                  case 2:
                    ...
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index6] > (sbyte) -64 /*0xC0*/)
                    {
                  ...
                  case 3:
                    ...
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index7] > (sbyte) -64 /*0xC0*/)
                    {
              ...
              if (cSensorRef.collided == (byte) 1)
              {
                ...
                if (cSensorRef.angle > (int) byte.MaxValue)
                  cSensorRef.angle -= 256 /*0x0100*/;
                if (Math.Abs(cSensorRef.angle - angle) > 32 /*0x20*/ && Math.Abs(cSensorRef.angle - 256 /*0x0100*/ - angle) > 32 /*0x20*/ && Math.Abs(cSensorRef.angle + 256 /*0x0100*/ - angle) > 32 /*0x20*/)
                {
                  cSensorRef.yPos = prevCollisionPos << 16 /*0x10*/;
                  cSensorRef.collided = (byte) 0;
      ...
      public static void LWallCollision(PlayerObject playerO, CollisionSensor cSensorRef)
      {
        ...
        for (int index1 = 0; index1 < 48 /*0x30*/; index1 += 16 /*0x10*/)
        {
          if (cSensorRef.collided == (byte) 0)
          {
            int num2 = (cSensorRef.xPos >> 16 /*0x10*/) - 16 /*0x10*/ + index1;
            int num3 = num2 >> 7;
            int num4 = (num2 & (int) sbyte.MaxValue) >> 4;
            int num5 = cSensorRef.yPos >> 16 /*0x10*/;
            int num6 = num5 >> 7;
            int num7 = (num5 & (int) sbyte.MaxValue) >> 4;
            if (num2 > -1 && num5 > -1)
            {
              ...
              if (StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] != (byte) 1 && StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] < (byte) 3)
              {
                switch (StageSystem.tile128x128.direction[index2])
                {
                  case 0:
                    ...
                    if ((num2 & 15) > (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].leftWallMask[index3] - 16 /*0x10*/ + index1)
                    {
                  ...
                  case 1:
                    ...
                    if ((num2 & 15) > 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index4] - 16 /*0x10*/ + index1)
                    {
                  ...
                  case 2:
                    ...
                    if ((num2 & 15) > (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].leftWallMask[index5] - 16 /*0x10*/ + index1)
                    {
                  ...
                  case 3:
                    ...
                    if ((num2 & 15) > 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index6] - 16 /*0x10*/ + index1)
                    {
        ...
        int prevCollisionPos)
      {
        ...
        for (int index1 = 0; index1 < 48 /*0x30*/; index1 += 16 /*0x10*/)
        {
          if (cSensorRef.collided == (byte) 0)
          {
            int num1 = (cSensorRef.xPos >> 16 /*0x10*/) - 16 /*0x10*/ + index1;
            int num2 = num1 >> 7;
            int num3 = (num1 & (int) sbyte.MaxValue) >> 4;
            int num4 = cSensorRef.yPos >> 16 /*0x10*/;
            int num5 = num4 >> 7;
            int num6 = (num4 & (int) sbyte.MaxValue) >> 4;
            if (num1 > -1 && num4 > -1)
            {
              ...
              if (StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] < (byte) 3)
              {
                switch (StageSystem.tile128x128.direction[index2])
                {
                  case 0:
                    ...
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].leftWallMask[index4] < (sbyte) 64 /*0x40*/)
                    {
                  ...
                  case 1:
                    ...
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index5] > (sbyte) -64 /*0xC0*/)
                    {
                      cSensorRef.xPos = 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index5] + (num2 << 7) + (num3 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = 256 /*0x0100*/ - (int) ((StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & 16711680U /*0xFF0000*/) >> 16 /*0x10*/);
                      break;
                    }
                    break;
                  case 2:
                    int index6 = 15 - (num4 & 15) + (index3 << 4);
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].leftWallMask[index6] < (sbyte) 64 /*0x40*/)
                    {
                  ...
                  case 3:
                    ...
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index7] > (sbyte) -64 /*0xC0*/)
                    {
                      cSensorRef.xPos = 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index7] + (num2 << 7) + (num3 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = 256 /*0x0100*/ - (384 - (int) ((StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & 16711680U /*0xFF0000*/) >> 16 /*0x10*/) & (int) byte.MaxValue);
                      break;
                    }
                    break;
                }
              ...
              if (cSensorRef.collided == (byte) 1)
              {
                ...
                if (cSensorRef.angle > (int) byte.MaxValue)
                  cSensorRef.angle -= 256 /*0x0100*/;
                if (Math.Abs(angle - cSensorRef.angle) > 32 /*0x20*/)
                {
                  cSensorRef.xPos = prevCollisionPos << 16 /*0x10*/;
                  cSensorRef.collided = (byte) 0;
                  cSensorRef.angle = angle;
                  index1 = 48 /*0x30*/;
                }
            ...
            if (num2 > -1 && num5 > -1)
            {
              ...
              if (StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] != (byte) 1 && StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] < (byte) 3)
              {
                switch (StageSystem.tile128x128.direction[index2])
                {
                  case 0:
                    int index3 = (num5 & 15) + (num8 << 4);
                    if ((num2 & 15) < (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index3] + 16 /*0x10*/ - index1)
                    {
                  ...
                  case 1:
                    int index4 = (num5 & 15) + (num8 << 4);
                    if ((num2 & 15) < 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].leftWallMask[index4] + 16 /*0x10*/ - index1)
                    {
                  ...
                  case 2:
                    int index5 = 15 - (num5 & 15) + (num8 << 4);
                    if ((num2 & 15) < (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index5] + 16 /*0x10*/ - index1)
                    {
                  ...
                  case 3:
                    int index6 = 15 - (num5 & 15) + (num8 << 4);
                    if ((num2 & 15) < 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].leftWallMask[index6] + 16 /*0x10*/ - index1)
                    {
            ...
            if (num1 > -1 && num4 > -1)
            {
              ...
              if (StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] < (byte) 3)
              {
                switch (StageSystem.tile128x128.direction[index2])
                {
                  case 0:
                    int index4 = (num4 & 15) + (index3 << 4);
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index4] > (sbyte) -64 /*0xC0*/)
                    {
                      cSensorRef.xPos = (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index4] + (num2 << 7) + (num3 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = (int) ((StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & 16711680U /*0xFF0000*/) >> 16 /*0x10*/);
                      break;
                    }
                    break;
                  case 1:
                    int index5 = (num4 & 15) + (index3 << 4);
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].leftWallMask[index5] < (sbyte) 64 /*0x40*/)
                    {
                      cSensorRef.xPos = 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].leftWallMask[index5] + (num2 << 7) + (num3 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = 256 /*0x0100*/ - (int) ((StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & 65280U) >> 8);
                      break;
                    }
                    break;
                  case 2:
                    int index6 = 15 - (num4 & 15) + (index3 << 4);
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index6] > (sbyte) -64 /*0xC0*/)
                    {
                      cSensorRef.xPos = (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].rightWallMask[index6] + (num2 << 7) + (num3 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = 384 - (int) ((StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & 16711680U /*0xFF0000*/) >> 16 /*0x10*/) & (int) byte.MaxValue;
                      break;
                    }
                    break;
                  case 3:
                    int index7 = 15 - (num4 & 15) + (index3 << 4);
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].leftWallMask[index7] < (sbyte) 64 /*0x40*/)
                    {
                      cSensorRef.xPos = 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].leftWallMask[index7] + (num2 << 7) + (num3 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = 256 /*0x0100*/ - (384 - (int) ((StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & 65280U) >> 8) & (int) byte.MaxValue);
                      break;
                    }
                    break;
                }
              ...
              if (cSensorRef.collided == (byte) 1)
              {
                ...
                if (cSensorRef.angle > (int) byte.MaxValue)
                  cSensorRef.angle -= 256 /*0x0100*/;
                if (Math.Abs(cSensorRef.angle - angle) > 32 /*0x20*/)
                {
                  cSensorRef.xPos = prevCollisionPos << 16 /*0x10*/;
                  cSensorRef.collided = (byte) 0;
                  cSensorRef.angle = angle;
            ...
            if (num2 > -1 && num5 > -1)
            {
              ...
              if (StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] != (byte) 1 && StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] < (byte) 3)
              {
                switch (StageSystem.tile128x128.direction[index2])
                {
                  case 0:
                    int index4 = (num2 & 15) + (index3 << 4);
                    if ((num5 & 15) < (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index4] + 16 /*0x10*/ - index1)
                    {
                      cSensorRef.yPos = (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index4] + (num6 << 7) + (num7 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = (int) ((StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & 4278190080U /*0xFF000000*/) >> 24);
                      break;
                    }
                    break;
                  case 1:
                    int index5 = 15 - (num2 & 15) + (index3 << 4);
                    if ((num5 & 15) < (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index5] + 16 /*0x10*/ - index1)
                    {
                      cSensorRef.yPos = (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index5] + (num6 << 7) + (num7 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = 256 /*0x0100*/ - (int) ((StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & 4278190080U /*0xFF000000*/) >> 24);
                      break;
                    }
                    break;
                  case 2:
                    int index6 = (num2 & 15) + (index3 << 4);
                    if ((num5 & 15) < 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index6] + 16 /*0x10*/ - index1)
                    {
                  ...
                  case 3:
                    int index7 = 15 - (num2 & 15) + (index3 << 4);
                    if ((num5 & 15) < 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index7] + 16 /*0x10*/ - index1)
                    {
                      cSensorRef.yPos = 15 - (int) StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index7] + (num6 << 7) + (num7 << 4);
                      cSensorRef.collided = (byte) 1;
                      cSensorRef.angle = 256 /*0x0100*/ - (384 - ((int) StageSystem.tileCollisions[(int) playerO.collisionPlane].angle[index3] & (int) byte.MaxValue) & (int) byte.MaxValue);
                      break;
                    }
                    break;
                }
            ...
            if (num1 > -1 && num4 > -1)
            {
              ...
              if (StageSystem.tile128x128.collisionFlag[(int) playerO.collisionPlane, index2] < (byte) 3)
              {
                switch (StageSystem.tile128x128.direction[index2])
                {
                  case 0:
                    int index4 = (num1 & 15) + (index3 << 4);
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index4] > (sbyte) -64 /*0xC0*/)
                    {
                  ...
                  case 1:
                    int index5 = 15 - (num1 & 15) + (index3 << 4);
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].roofMask[index5] > (sbyte) -64 /*0xC0*/)
                    {
                  ...
                  case 2:
                    int index6 = (num1 & 15) + (index3 << 4);
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index6] < (sbyte) 64 /*0x40*/)
                    {
                  ...
                  case 3:
                    int index7 = 15 - (num1 & 15) + (index3 << 4);
                    if (StageSystem.tileCollisions[(int) playerO.collisionPlane].floorMask[index7] < (sbyte) 64 /*0x40*/)
                    {
