...
namespace Retro_Engine
{
    ...
    {
      public static SpriteFrame[] animationFrames = new SpriteFrame[4096 /*0x1000*/];
      public static int animationFramesNo = 0;
      public static SpriteAnimation[] animationList = new SpriteAnimation[1024 /*0x0400*/];
      public static int animationListNo = 0;
      public static AnimationFileList[] animationFile = new AnimationFileList[256 /*0x0100*/];
      public static int animationFileNo = 0;
      public static CollisionBox[] collisionBoxList = new CollisionBox[32 /*0x20*/];
      ...
      public static void LoadAnimationFile(char[] filePath)
      {
        ...
        for (int index3 = 0; index3 < AnimationSystem.animationFile[AnimationSystem.animationFileNo].numAnimations; ++index3)
        {
          byte num4 = FileIO.ReadByte();
          int index4;
          for (index4 = 0; index4 < (int) num4; ++index4)
            AnimationSystem.animationList[AnimationSystem.animationListNo].name[index4] = (char) FileIO.ReadByte();
          AnimationSystem.animationList[AnimationSystem.animationListNo].name[index4] = char.MinValue;
          byte num5 = FileIO.ReadByte();
          AnimationSystem.animationList[AnimationSystem.animationListNo].numFrames = num5;
          byte num6 = FileIO.ReadByte();
          AnimationSystem.animationList[AnimationSystem.animationListNo].animationSpeed = num6;
          byte num7 = FileIO.ReadByte();
          AnimationSystem.animationList[AnimationSystem.animationListNo].loopPosition = num7;
          byte num8 = FileIO.ReadByte();
          AnimationSystem.animationList[AnimationSystem.animationListNo].rotationFlag = num8;
          AnimationSystem.animationList[AnimationSystem.animationListNo].frameListOffset = AnimationSystem.animationFramesNo;
          for (int index5 = 0; index5 < (int) AnimationSystem.animationList[AnimationSystem.animationListNo].numFrames; ++index5)
          {
            byte index6 = FileIO.ReadByte();
            AnimationSystem.animationFrames[AnimationSystem.animationFramesNo].surfaceNum = numArray[(int) index6];
        ...
        for (int index7 = 0; index7 < (int) num16; ++index7)
        {
          ...
          {
            AnimationSystem.collisionBoxList[AnimationSystem.collisionBoxNo].left[index8] = (sbyte) FileIO.ReadByte();
            AnimationSystem.collisionBoxList[AnimationSystem.collisionBoxNo].top[index8] = (sbyte) FileIO.ReadByte();
            AnimationSystem.collisionBoxList[AnimationSystem.collisionBoxNo].right[index8] = (sbyte) FileIO.ReadByte();
            AnimationSystem.collisionBoxList[AnimationSystem.collisionBoxNo].bottom[index8] = (sbyte) FileIO.ReadByte();
          }
      ...
      public static AnimationFileList GetDefaultAnimationRef() => AnimationSystem.animationFile[0];
        ...
        ObjectEntity currentObject)
      {
        ...
        {
          if (currentObject.animationSpeed > 240 /*0xF0*/)
            currentObject.animationSpeed = 240 /*0xF0*/;
        ...
        {
          currentObject.animationTimer -= 240 /*0xF0*/;
          ++currentObject.frame;
        }
        ...
        int yPos)
      {
        switch (animationRef.rotationFlag)
        {
          ...
          case 2:
            ...
            int rotAngle1 = currentObject.rotation >= 256 /*0x0100*/ ? 512 /*0x0200*/ - (532 - currentObject.rotation >> 6 << 6) : currentObject.rotation + 20 >> 6 << 6;
            ...
            break;
          case 3:
            int rotAngle2 = currentObject.rotation >= 256 /*0x0100*/ ? 8 - (532 - currentObject.rotation >> 6) : currentObject.rotation + 20 >> 6;
            ...
            switch (rotAngle2)
            {
              ...
              case 1:
                ...
                rotAngle2 = currentObject.direction != (byte) 0 ? 0 : 128 /*0x80*/;
                break;
              case 2:
                rotAngle2 = 128 /*0x80*/;
                break;
              case 3:
                frame += (int) animationRef.numFrames;
                rotAngle2 = currentObject.direction != (byte) 0 ? 128 /*0x80*/ : 256 /*0x0100*/;
                break;
              case 4:
                rotAngle2 = 256 /*0x0100*/;
                break;
              case 5:
                frame += (int) animationRef.numFrames;
                rotAngle2 = currentObject.direction != (byte) 0 ? 256 /*0x0100*/ : 384;
                break;
              case 6:
                rotAngle2 = 384;
                break;
