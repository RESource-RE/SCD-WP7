...
namespace Retro_Engine
{
    ...
    public class GifDecoder
    {
      ...
      public byte[] buffer = new byte[256 /*0x0100*/];
      public byte[] stack = new byte[4096 /*0x1000*/];
      public byte[] suffix = new byte[4096 /*0x1000*/];
      public uint[] prefix = new uint[4096 /*0x1000*/];
    }
}
